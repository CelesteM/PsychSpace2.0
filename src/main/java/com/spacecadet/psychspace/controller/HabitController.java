...
public class HabitController {
    ...
    public String submitCue(@ModelAttribute("cue") Cue cue, @PathVariable("courseKey") String courseKey){
        Habit habit = habitManager.loadUserHabit(WelcomeController.currUser.getUserKey(), courseKey);
    ...
    /**
     * addreward on habit page
     * @param habit  new habit
     * @param courseKey course key
     * @return redirect to habit page
     */
    @RequestMapping(value = "/learn/{courseKey}/habit/submitReward", method = RequestMethod.POST)
    public String submitCue(@ModelAttribute("habit") Habit habit, @PathVariable("courseKey") String courseKey){
        habitManager.editHabit(habit);
        return "redirect:/learn/"+courseKey+"/habit";
    }
