        ...
        <body>
            ...
            <header class="ps-feature-header">
                <div class="center page-banner">
                    <img class="img-responsive" src="${contextPath}/resources/img/banner_catalogue.png" alt="">
                        ...
                        <div class="row ps-text-content">
                            ...
                            <div class="col-lg-4 fadein">
                                <div class="ps-well">
                                    ...
                                    <br>
                                    <!-- Course Image -->
                                    <img class="img-responsive course-img" src="${contextPath}/resources/img/dummy_image.png" alt="">
                                    <br>
                                    <!-- Status -->
                        ...
                        <div class="row ps-text-content">
                            ...
                            <div class="col-lg-4">
                                <div class="ps-well">
                                    ...
                                    <br>
                                    <!-- Course Image -->
                                    <img class="img-responsive course-img fadein" src="${contextPath}/resources/img/dummy_image.png" alt="">
                                    <br>
