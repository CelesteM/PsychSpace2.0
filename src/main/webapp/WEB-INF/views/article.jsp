    ...
    <div class="ps-feature-content">
        <div class="row ps-feature">
            <div class="ps-feature-info">
                ...
                <!-- Author -->
                <div class="media">
                    <a class="pull-left" href="#"> <img class="media-object" src="${contextPath}/resources/img/dummy_profile.png" alt="">
                    </a>
        ...
        <div class="row ps-text-content">
            <div class="col-lg-8 ps-col-left">
                <div class="ps-well">
                    <div class="center">
                        <img class="ps-feature-img img-responsive" src="${contextPath}/resources/img/dummy_image.png" alt="">
                    </div>
                    <!-- Post Content -->
                    <p>${article.content}</p>
                </div>
            ...
            <div class="col-lg-4 ps-col-right">
                <div class="ps-well">
                    ...
                    <div class="left">
                        ...
                        <div class="center">
                            <img class="ps-feature-img img-responsive" src="${contextPath}/resources/img/dummy_image.png" alt="image">
                    ...
                    <div id="psLeaveComment" class="col-lg ps-well">
                        <div class="left">
                            ...
                            <form:form class="form-horizontal" method="post" modelAttribute="comment"
                                ...
                                <div class="right">
                                    <button id="btn-comment-post" type="submit" class="btn-comment ps-btn-primary">Submit
                                    </button>
                                </div>
                            </form:form>
                        </div>
            ...
            <div id="ps-comment-section">
                <c:forEach items="${commentList}" var="articleComment">
                    ...
                    <div class="media ps-comment">
                        ...
                        <a class="pull-left" href="#"> <img class="media-object" src="${contextPath}/resources/img/dummy_profile.png" alt=""></a>
                        <div class="media-body">
